...
from tsne_vector_indexer import TSNEBasedVectorIndexer


class TSNE_Based_RAG_Util():
    def __init__( 
                    self,
        ...
        self.vector_indexer = TSNEBasedVectorIndexer(  
                    input_dimensions = self.vector_encoder.get_encoded_vector_dimensions(),
