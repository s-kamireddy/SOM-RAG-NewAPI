...
from umap_vector_indexer import UMAPBasedVectorIndexer


class UMAP_Based_RAG_Util():
    def __init__( 
                    self,
        ...
        self.vector_indexer = UMAPBasedVectorIndexer(    input_dimensions = self.vector_encoder.get_encoded_vector_dimensions(),
    ...
    def train_n_index_data_vectors( self,  ):
        ...
        self.vector_indexer.train_n_gen_indexes( self.vectors )
